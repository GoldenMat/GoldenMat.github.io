	...
	<div class="container">
		...
		<div class="content">
			...
			<div id="condizioni" class="condizioni hidden">
				...
				<table class="info escursionismo">
					<tr>
						...
						<td>Mattinata tersa e non fredda. I sentiero sono in ottimo stato come sempre, non c'è neve o almeno non che impedisca di camminare sull'asciutto.</td>
					</tr>
					<tr>
			...
			<div id="racconti" class="racconti hidden">
				...
				<div class="story left">
					...
					<div class="story-block escursionismo">
						Alba pre lavoro, salgo con buon ritmo nonostante la tosse, non c'è neve infatti ho su scarpe d'avvicinamento. In cima solo un'altra persona, che appena dopo l'alba scende verso Ballabio. Niente vento e niente freddo, mattinata limpida nonostante ciò. Scendo con calma verso Olino dopo essermi mangiato un tocchello di cioccolato.
					</div>
				</div>
			</div>
			...
			<div id="foto" class="foto hidden">
				...
				<a href="https://photos.app.goo.gl/pLoyERDNbAbQhpdX8" target="_blank" rel="noopener noreferrer">
