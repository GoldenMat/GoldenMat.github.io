...
<div id="relazione" class="relazione">
    ...
    <table class="info roccia">
        ...
        <tr>
            ...
            <td>900m (circa)</td>
            <th>Tempi</th>
            <td>06:00 ore (03:00 ore la via)</td>
        </tr>
        <tr>
            <th>Esposizione</th>
            <td>Ovest</td>
    ...
    <div class="left">
        ...
        <div class="halved-grid">
            ...
            <div class="halved-block-text">Seguire il canale Angelina in ambiente bellissimo, facendo attenzione circa a metà a seguire le catene di sinistra. Superate queste si può decidere se ritraversare all'interno del canale (sentiero bollato). Oppure seguire il prato che su roccia non solidissima porta fino a un caminetto, che superato con qualche passo di arrampicata porta al colletto del Clerici, dove ci si ricongiunge al sentiero normale con qualche passo di arrampicata facile ma esposto. Seguire ora il sentiero Cecilia verso sinistra aggirando dei salti e con qualche catena facile fino ad arrivare al colle Valsecchi. Un cartello indica l'attacco della via sulla destra che per pochi metri di roccette si raggiunge, una comoda piazzola posta alla sinistra di un canale appoggiato che sale verso la cima del torrione.</div>
        ...
        <div class="halved-grid">
            <div class="halved-block-text"><b>L1:</b> salire il camino, inizialmente molto facile poi sempre non difficile ma orrido (variante di difficoltà uguale se si esce sullo spigolo di destra), difficile da proteggere, fino all'evidente forcella dove si sosta su un fix o meglio ancora grosso spuntone sulla destra.
            <br>&#187; 35m, fix alla forcella (I, II+)</div>
            ...
            <div class="halved-block-text"><b>Raccordo:</b> proseguire seguendo la crestina con inizialmente una discesina delicata (II, evitabile sulla destra per terreno friabile), poi si aggira un roccione per sentiero sulla destra individuando una cengia che con un passo finale verticale in discesa (II, buone mani e resinato sopra) consente di superare l'intaglio e risalire fino alla sosta su 2 resinati sul torrione successivo.
            <br>&#187; 100m (circa), qualche resinato (II e sentiero)</div>
            ...
            <div class="halved-block-text"><b>L7:</b> salire in verticale dapprima per roccette poi per fessura abbastanza verticale, fino a raggiungere l'intaglio sulla cresta (resinato sulla destra per sostare). Tiro bello fresco e non difficile.
            <br>&#187; 15m (II)</div>
