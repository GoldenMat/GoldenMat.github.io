<?php
	$folder = "/relazioni/29_2_3/crestapiancaformia-invernale/";
?>
...
<div id="relazione" class="relazione">
	...
	<table class="info ghiaccio">
		...
		<tr>
			...
			<td>Passo Cainallo - Esino Lario (LC)</td>
			<th>Quota</th>
			<td>
				1300m la partenza<br>
				1805m la Bocchetta di Piancaformia<br>
				2106m la Cima di Piancaformia<br>
				2410m la cima
			</td>
		</tr>
		<tr>
			...
			<td>1200m (circa)</td>
			<th>Tempi</th>
			<td>6:00 ore (2:30 ore la cresta)</td>
		</tr>
		<tr>
			<th>Esposizione</th>
			<td>Nord-Ovest</td>
		...
		<tr>
			...
			<td>Bivacco 89a Brigata Poletti, Rifugio Brioschi, Rifugio Bogani</td>
			<th>Acqua</th>
			<td>Niente, solo ai rifugi (che potrebbero essere chiusi d'inverno)</td>
		</tr>
		<tr>
			<th>Partecipanti</th>
	...
	<div class="left">
		...
		<div class="halved-grid">
			<div class="halved-block-text">Seguire la cresta inizialmente tra alberelli e roccette, poi via via sempre più aerea fino ad arrivare sotto la cima di Piancaformia. Qua a seconda delle condizioni nevose si può seguire il filo (più impegnativo con poca neve) o star sul lato destro dove passa il sentiero estivo (esposto con tanta neve). Nella parte alta il sentiero torna sul filo che si segue via via con meno difficoltà fino a sbucare sulla Cima di Piancaformia, dove il panorama sulla parte restante dell'itinerario è favoloso.</div>
			...
			<div class="halved-block-text">La parte finale, soprattutto in condizioni di neve non buone, è la più impegnativa: qui è facile traversando su neve (occhio ai pendii) ricongiungersi alla parte finale della via della Ganda, che sale il largo canale appena sotto la cappelletta del Rifugio Brioschi. Se invece si percorresse la parte finale solitamente si effettua un traverso ascendente verso sinistra (Nord) fino a un canaletto poco visibile (si capisce di essere nel punto giusto poichè presente una rete che chiude una grotta), il quale si risale fino a sbucare nuovamente in cresta. Da qui prosegue abbastanza fedelmente sul filo, aereo ma non eccessivamente difficile, passando l'uscita dei vari canali (e delle soste per calarsi nelle grotte a sinistra) fino al pezzo finale, che va solitamente fatto sul versante destro (Ovest) del filo, uscendo a pochi metri dall'ancoraggio finale della catena che porta in cima al Grignone dalla Ganda.</div>
